...
CELL_STATE_PLASMA_ENERGY = 850
CELL_STATE_GAS_ENERGY = 600
CELL_STATE_LIQUID_ENERGY = 300
CELL_STATE_MESOPHASE_ENERGY = 150
CELL_STATE_SOLID_ENERGY = 50
CELL_STATE_INERT_ENERGY = 0
INERT_STONE_SOFTNESS = 60
...
CELL_BASE_ENERGY_MAX = 500

# energy storage
CELL_BASE_ENERGY_STORAGE_MIN = 200
CELL_BASE_ENERGY_STORAGE_MAX = 1000
CELL_PLASMA_ENERGY_STORAGE_MIN = 600
CELL_PLASMA_ENERGY_STORAGE_MAX = 1000
CELL_GAS_ENERGY_STORAGE_MIN = 500
CELL_GAS_ENERGY_STORAGE_MAX = 1000
CELL_LIQUID_ENERGY_STORAGE_MIN = 400
CELL_LIQUID_ENERGY_STORAGE_MAX = 1000
CELL_MESOPHASE_ENERGY_STORAGE_MIN = 300
CELL_MESOPHASE_ENERGY_STORAGE_MAX = 1000
CELL_SOLID_ENERGY_STORAGE_MIN = 200
CELL_SOLID_ENERGY_STORAGE_MAX = 1000
CELL_INERT_ENERGY_STORAGE_MIN = 100
CELL_INERT_ENERGY_STORAGE_MAX = 1000
...
CELL_PLASMA_LIGHT_ABSORPTION_MIN = 50
CELL_PLASMA_LIGHT_ABSORPTION_MAX = 100
...
# light storage
CELL_BASE_LIGHT_STORAGE_MIN = 200
CELL_BASE_LIGHT_STORAGE_MAX = 1000
CELL_PLASMA_LIGHT_STORAGE_MIN = 600
CELL_PLASMA_LIGHT_STORAGE_MAX = 1000
CELL_GAS_LIGHT_STORAGE_MIN = 500
CELL_GAS_LIGHT_STORAGE_MAX = 1000
CELL_LIQUID_LIGHT_STORAGE_MIN = 400
CELL_LIQUID_LIGHT_STORAGE_MAX = 1000
CELL_MESOPHASE_LIGHT_STORAGE_MIN = 300
CELL_MESOPHASE_LIGHT_STORAGE_MAX = 1000
CELL_SOLID_LIGHT_STORAGE_MIN = 200
CELL_SOLID_LIGHT_STORAGE_MAX = 1000
CELL_INERT_LIGHT_STORAGE_MIN = 100
CELL_INERT_LIGHT_STORAGE_MAX = 1000

# light absorption
CELL_BASE_INERT_ABSORPTION_MIN = 40
CELL_BASE_INERT_ABSORPTION_MAX = 70
CELL_PLASMA_INERT_ABSORPTION_MIN = 50
CELL_PLASMA_INERT_ABSORPTION_MAX = 100
CELL_GAS_INERT_ABSORPTION_MIN = 40
CELL_GAS_INERT_ABSORPTION_MAX = 60
CELL_LIQUID_INERT_ABSORPTION_MIN = 50
CELL_LIQUID_INERT_ABSORPTION_MAX = 70
CELL_MESOPHASE_INERT_ABSORPTION_MIN = 0
CELL_MESOPHASE_INERT_ABSORPTION_MAX = 100
CELL_SOLID_INERT_ABSORPTION_MIN = 20
CELL_SOLID_INERT_ABSORPTION_MAX = 40
CELL_INERT_INERT_ABSORPTION_MIN = 0
CELL_INERT_INERT_ABSORPTION_MAX = 10

# light emission
CELL_BASE_INERT_EMISSION_MIN = 0
CELL_BASE_INERT_EMISSION_MAX = 30
CELL_PLASMA_INERT_EMISSION_MIN = 70
CELL_PLASMA_INERT_EMISSION_MAX = 100
CELL_GAS_INERT_EMISSION_MIN = 20
CELL_GAS_INERT_EMISSION_MAX = 60
CELL_LIQUID_INERT_EMISSION_MIN = 5
CELL_LIQUID_INERT_EMISSION_MAX = 30
CELL_MESOPHASE_INERT_EMISSION_MIN = 0
CELL_MESOPHASE_INERT_EMISSION_MAX = 70
CELL_SOLID_INERT_EMISSION_MIN = 0
CELL_SOLID_INERT_EMISSION_MAX = 20
CELL_INERT_INERT_EMISSION_MIN = 0
CELL_INERT_INERT_EMISSION_MAX = 10

# light storage
CELL_BASE_INERT_STORAGE_MIN = 200
CELL_BASE_INERT_STORAGE_MAX = 1000
CELL_PLASMA_INERT_STORAGE_MIN = 600
CELL_PLASMA_INERT_STORAGE_MAX = 1000
CELL_GAS_INERT_STORAGE_MIN = 500
CELL_GAS_INERT_STORAGE_MAX = 1000
CELL_LIQUID_INERT_STORAGE_MIN = 400
CELL_LIQUID_INERT_STORAGE_MAX = 1000
CELL_MESOPHASE_INERT_STORAGE_MIN = 300
CELL_MESOPHASE_INERT_STORAGE_MAX = 1000
CELL_SOLID_INERT_STORAGE_MIN = 200
CELL_SOLID_INERT_STORAGE_MAX = 1000
CELL_INERT_INERT_STORAGE_MIN = 100
CELL_INERT_INERT_STORAGE_MAX = 1000
...
# height preference
CELL_BASE_HEIGHT_PREF_MIN = 0
CELL_BASE_HEIGHT_PREF_MAX = 5000
CELL_PLASMA_HEIGHT_PREF_MIN = 100
CELL_PLASMA_HEIGHT_PREF_MAX = 4000
CELL_GAS_HEIGHT_PREF_MIN = 1000
CELL_GAS_HEIGHT_PREF_MAX = 4000
CELL_LIQUID_HEIGHT_PREF_MIN = 0
CELL_LIQUID_HEIGHT_PREF_MAX = 200
CELL_MESOPHASE_HEIGHT_PREF_MIN = 0
CELL_MESOPHASE_HEIGHT_PREF_MAX = 4000
CELL_SOLID_HEIGHT_PREF_MIN = 0
CELL_SOLID_HEIGHT_PREF_MAX = 4000
CELL_INERT_HEIGHT_PREF_MIN = 0
CELL_INERT_HEIGHT_PREF_MAX = 5000
...
# fertility age
CELL_BASE_FERTILITY_START_AGE_MIN = random.uniform(0.9, 1.1) * CELL_BASE_DEATH_AGE_MIN/100 # min = 1% of death age +- 10%
CELL_BASE_FERTILITY_START_AGE_MAX = random.uniform(0.9, 1.1) * random.uniform(CELL_BASE_FERTILITY_START_AGE_MIN, CELL_BASE_DEATH_AGE_MIN) # max = random between start age and death age min
CELL_BASE_FERTILITY_END_AGE_MIN = random.uniform(1,2) * CELL_BASE_FERTILITY_START_AGE_MAX # end min = 1-2x fertility start
CELL_BASE_FERTILITY_END_AGE_MAX = random.uniform(CELL_BASE_DEATH_AGE_MIN, CELL_BASE_DEATH_AGE_MAX) # end max = random between death min and death max
CELL_PLASMA_FERTILITY_START_AGE_MIN = random.uniform(0.9, 1.1) * CELL_PLASMA_DEATH_AGE_MIN/100
...
CELL_GAS_FERTILITY_START_AGE_MIN = random.uniform(0.9, 1.1) * CELL_GAS_DEATH_AGE_MIN/100
...
CELL_LIQUID_FERTILITY_START_AGE_MIN = random.uniform(0.9, 1.1) * CELL_LIQUID_DEATH_AGE_MIN/100
...
CELL_MESOPHASE_FERTILITY_START_AGE_MIN = random.uniform(0.9, 1.1) * CELL_MESOPHASE_DEATH_AGE_MIN/100
...
CELL_SOLID_FERTILITY_START_AGE_MIN = random.uniform(0.9, 1.1) * CELL_SOLID_DEATH_AGE_MIN/100
...
CELL_INERT_FERTILITY_START_AGE_MIN = random.uniform(0.9, 1.1) * CELL_INERT_DEATH_AGE_MIN/100
...
CELL_BASE_FERTILITY_ENERGY_MAX = 800
CELL_PLASMA_FERTILITY_ENERGY_MIN = 200
CELL_PLASMA_FERTILITY_ENERGY_MAX = 800
CELL_GAS_FERTILITY_ENERGY_MIN = 300
CELL_GAS_FERTILITY_ENERGY_MAX = 800
CELL_LIQUID_FERTILITY_ENERGY_MIN = 400
CELL_LIQUID_FERTILITY_ENERGY_MAX = 800
CELL_MESOPHASE_FERTILITY_ENERGY_MIN = 500
CELL_MESOPHASE_FERTILITY_ENERGY_MAX = 800
CELL_SOLID_FERTILITY_ENERGY_MIN = 600
CELL_SOLID_FERTILITY_ENERGY_MAX = 800
CELL_INERT_FERTILITY_ENERGY_MIN = 700
CELL_INERT_FERTILITY_ENERGY_MAX = 800

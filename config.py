...
# growth rate
CELL_BASE_GROWTH_RATE_MIN = 0.8
CELL_BASE_GROWTH_RATE_MAX = 1.2
CELL_PLASMA_GROWTH_RATE_MIN = 1.2
CELL_PLASMA_GROWTH_RATE_MAX = 1.6
CELL_GAS_GROWTH_RATE_MIN = 0.8
CELL_GAS_GROWTH_RATE_MAX = 1.2
CELL_LIQUID_GROWTH_RATE_MIN = 0.8
CELL_LIQUID_GROWTH_RATE_MAX = 1.2
CELL_MESOPHASE_GROWTH_RATE_MIN = 0.8
CELL_MESOPHASE_GROWTH_RATE_MAX = 1.2
CELL_SOLID_GROWTH_RATE_MIN = 0.8
CELL_SOLID_GROWTH_RATE_MAX = 1.2
CELL_INERT_GROWTH_RATE_MIN = 0.8
CELL_INERT_GROWTH_RATE_MAX = 1.2

# resilience
CELL_BASE_RESILIENCE_MIN = 0.8
CELL_BASE_RESILIENCE_MAX = 1.2 
CELL_PLASMA_RESILIENCE_MIN = 0.8
CELL_PLASMA_RESILIENCE_MAX = 1.2 
CELL_GAS_RESILIENCE_MIN = 0.8
CELL_GAS_RESILIENCE_MAX = 1.2 
CELL_LIQUID_RESILIENCE_MIN = 0.8
CELL_LIQUID_RESILIENCE_MAX = 1.2 
CELL_MESOPHASE_RESILIENCE_MIN = 0.8
CELL_MESOPHASE_RESILIENCE_MAX = 1.2 
CELL_SOLID_RESILIENCE_MIN = 0.8
CELL_SOLID_RESILIENCE_MAX = 1.2 
CELL_INERT_RESILIENCE_MIN = 0.8
CELL_INERT_RESILIENCE_MAX = 1.2 

# perception
CELL_BASE_PERCEPTION_MIN = 0.1
CELL_BASE_PERCEPTION_MAX = 0.5
CELL_PLASMA_PERCEPTION_MIN = 0.1
CELL_PLASMA_PERCEPTION_MAX = 0.5
CELL_GAS_PERCEPTION_MIN = 0.1
CELL_GAS_PERCEPTION_MAX = 0.5
CELL_LIQUID_PERCEPTION_MIN = 0.1
CELL_LIQUID_PERCEPTION_MAX = 0.5
CELL_MESOPHASE_PERCEPTION_MIN = 0.1
CELL_MESOPHASE_PERCEPTION_MAX = 0.5
CELL_SOLID_PERCEPTION_MIN = 0.1
CELL_SOLID_PERCEPTION_MAX = 0.5
CELL_INERT_PERCEPTION_MIN = 0.1
CELL_INERT_PERCEPTION_MAX = 0.5

# speed
CELL_BASE_SPEED_MIN = 0.5
CELL_BASE_SPEED_MAX = 1.5
CELL_PLASMA_SPEED_MIN = 0.5
CELL_PLASMA_SPEED_MAX = 1.5
CELL_GAS_SPEED_MIN = 0.5
CELL_GAS_SPEED_MAX = 1.5
CELL_LIQUID_SPEED_MIN = 0.5
CELL_LIQUID_SPEED_MAX = 1.5
CELL_MESOPHASE_SPEED_MIN = 0.5
CELL_MESOPHASE_SPEED_MAX = 1.5
CELL_SOLID_SPEED_MIN = 0.5
CELL_SOLID_SPEED_MAX = 1.5
CELL_INERT_SPEED_MIN = 0.5
CELL_INERT_SPEED_MAX = 1.5

# light absorption
CELL_BASE_LIGHT_ABSORPTION_MIN = 0.1
CELL_BASE_LIGHT_ABSORPTION_MAX = 1.0
CELL_PLASMA_LIGHT_ABSORPTION_MIN = 0.1
CELL_PLASMA_LIGHT_ABSORPTION_MAX = 1.0
CELL_GAS_LIGHT_ABSORPTION_MIN = 0.1
CELL_GAS_LIGHT_ABSORPTION_MAX = 1.0
CELL_LIQUID_LIGHT_ABSORPTION_MIN = 0.1
CELL_LIQUID_LIGHT_ABSORPTION_MAX = 1.0
CELL_MESOPHASE_LIGHT_ABSORPTION_MIN = 0.1
CELL_MESOPHASE_LIGHT_ABSORPTION_MAX = 1.0
CELL_SOLID_LIGHT_ABSORPTION_MIN = 0.1
CELL_SOLID_LIGHT_ABSORPTION_MAX = 1.0
CELL_INERT_LIGHT_ABSORPTION_MIN = 0.1
CELL_INERT_LIGHT_ABSORPTION_MAX = 1.0

# light emission
CELL_BASE_LIGHT_EMISSION_MIN = 0
CELL_BASE_LIGHT_EMISSION_MAX = 0.3
CELL_PLASMA_LIGHT_EMISSION_MIN = 0
CELL_PLASMA_LIGHT_EMISSION_MAX = 0.3
CELL_GAS_LIGHT_EMISSION_MIN = 0
CELL_GAS_LIGHT_EMISSION_MAX = 0.3
CELL_LIQUID_LIGHT_EMISSION_MIN = 0
CELL_LIQUID_LIGHT_EMISSION_MAX = 0.3
CELL_MESOPHASE_LIGHT_EMISSION_MIN = 0
CELL_MESOPHASE_LIGHT_EMISSION_MAX = 0.3
CELL_SOLID_LIGHT_EMISSION_MIN = 0
CELL_SOLID_LIGHT_EMISSION_MAX = 0.3
CELL_INERT_LIGHT_EMISSION_MIN = 0
CELL_INERT_LIGHT_EMISSION_MAX = 0.3

...
CELL_PLASMA_FERTILITY_ENERGY_MAX = 400
...
CELL_DECAY_TOP_ENERGY_MULTIPLIER = 1
...
MAIN_GRID_IMPORTANCE = 0.2
INERT_GRID_TRANSPARENCY = 1
INERT_GRID_IMPORTANCE = 0.1
ATTRACTIVENESS_GRID_TRANSPARENCY = 0.5
ATTRACTIVENESS_GRID_IMPORTANCE = 0.6
LIGHT_GRID_TRANSPARENCY = 0.3
LIGHT_GRID_IMPORTANCE = 1
